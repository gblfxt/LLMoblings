 ...
 */
@EventBusSubscriber(modid = LLMoblings.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
public class ChunkLoadingManager {
    ...
    public static void registerTicketControllers(RegisterTicketControllersEvent event) {
        ticketController = new TicketController(
                LLMoblings.id("companion_loader"),
                (level, helper) -> {
        ...
        LLMoblings.LOGGER.info("Registered companion chunk loading controller");
    }
